...
function Footer() {
    return (
        <footer
            className="flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-neutral-200 dark:text-white">
            ...
            <div className="w-full bg-black/5 p-4 text-center text-slate-600">
                © 2024 Copyright:
                <a href="https://tw-elements.com/"> Paola Guzmán / Juan Manuel Castro</a>
            </div>
        </footer>
